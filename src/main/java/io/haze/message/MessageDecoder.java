 ...
 */
@Sharable
public abstract class MessageDecoder extends MessageToMessageDecoder<MessageContext> implements FactoryInitializer {
    ...
    /**
     * Initialize this {@link MessageDecoder}.
     *
    ...
    /**
     * Retrieve the string representation of this {@link MessageDecoder}.
     */
    @Override
