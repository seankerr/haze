...
public class ShutdownResponse extends Message {
    ...
    /**
     * Create a new {@link ShutdownResponse} instance.
     *
    ...
    /**
     * Write a serialized version of this {@link ShutdownResponse} onto the {@link MessageWriter}.
     *
     * @param writer The message writer.
     */
    @Override
    public void serialize (MessageWriter writer) {
        writer.writeShort((short) "shutdown".length())
              .writeBytes("shutdown".getBytes())
              .writeShort((short) message.length())
